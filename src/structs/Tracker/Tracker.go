...
func (tracker Tracker) HandleDownload(reader IO.Reader, writer IO.Writer) {
	...
	tmpConn, err := net.Dial("tcp", "10.0.151.148:9091") // 9091 hardkodovano jer tamo slusa peer
	CheckError(err)
